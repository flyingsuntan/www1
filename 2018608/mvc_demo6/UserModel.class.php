...
class UserModel extends BaseModel {
    ...
    function EditAction($user ,$pwd,$age,$Education,$Interest,$fr,$id){
        $sql = "update  yonghubiao set username='$user' ,pwd=md5('$pwd'),age='$age',Education='$Education',Interest='$Interest',fr='$fr',addate=now() where id = $id";
        $date = $this->_dao->exec($sql);
        return $date;
    }
