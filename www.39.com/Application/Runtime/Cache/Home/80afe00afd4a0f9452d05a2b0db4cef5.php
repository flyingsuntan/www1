 ...
 foreach($_GET as $k => $v): if(strpos($k,'attr_')===0): ?>
			...
			<div class="filter mt10">
				...
				<div class="filter_wrap">
					...
					<dl>
						...
						<dd><a href="/index.php/Home/Search/cat_search/cat_id/22/brand_id/<?php echo $v['brand_id'];?>-<?php echo $v['brand_name'];?>"><?php echo $v['brand_name']?></a></dd>
						<?php endforeach;?>
					</dl>
					<?php endif;?>
					...
					<dl>
						...
						<dd><a href="/index.php/Home/Search/cat_search/cat_id/22/price/<?php echo $v;?>"><?php echo $v?></a></dd>
						<?php endforeach;?>
					...
					<dl>
						...
						<dd><a href="/index.php/Home/Search/cat_search/cat_id/22/<?php echo $attrUrlName;?>/<?php echo $v1['attr_value'];?>-<?php echo $k;?>"><?php echo $v1['attr_value']?></a></dd>
						<?php endforeach;?>
					</dl>
					<?php endforeach;?>
				</div>
			...
			<div class="sort mt10">
				...
				<dl>
					...
					<!--<dd><a href="/index.php/Home/Search/cat_search/cat_id/22/odby/price_desc">评论数</a></dd>-->
