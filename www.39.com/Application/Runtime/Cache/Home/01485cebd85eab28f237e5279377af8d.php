	...
	<div class="list w1210 bc mt10">
		...
		<div class="list_bd fl ml10 mt10">
			...
			<style>
				...
				#search_condition span {border:1px solid #F00;padding: 5px;margin: 3px}
				#search_condition span a:hover {background: #F00;color: #FFF;padding: 5px;margin-right: 0px}
			</style>
			<div id="search_condition">
			当前搜索条件：
				<?php
 $brandId = I('get.brand_id'); $price = I('get.price'); if($brandId): ?>
				<span>
				...
				<?php
 foreach($_GET as $k => $v): if(strpos($k,'attr_')===0): ?>
				<span>
				<?php echo ltrim(strrchr($v,'-'),'-');?>：<?php echo substr($v,0,strrpos($v,'-'));?>
			...
			<div class="filter mt10">
				...
				<div class="filter_wrap">
					...
					<dl>
						...
						<dd><a href="/index.php/Home/Search/key_search/key/%E7%BE%8E%E7%9A%84/brand_id/<?php echo $v['brand_id'];?>-<?php echo $v['brand_name'];?>"><?php echo $v['brand_name']?></a></dd>
						<?php endforeach;?>
					</dl>
					<?php endif;?>
					...
					<dl>
						...
						<dd><a href="/index.php/Home/Search/key_search/key/%E7%BE%8E%E7%9A%84/price/<?php echo $v;?>"><?php echo $v?></a></dd>
						<?php endforeach;?>
					...
					<dl>
						...
						<dd><a href="/index.php/Home/Search/key_search/key/%E7%BE%8E%E7%9A%84/<?php echo $attrUrlName;?>/<?php echo $v1['attr_value'];?>-<?php echo $k;?>"><?php echo $v1['attr_value']?></a></dd>
						<?php endforeach;?>
					</dl>
					<?php endforeach;?>
				</div>
			...
			<div class="sort mt10">
				...
				<dl>
					<dt>排序：</dt>
					<dd <?php if($odby == 'xl') echo 'class="cur"'?>><a href="<?php filterUrl('odby')?>/odby/xl">销量</a></dd>
					<dd <?php if(strpos($odby,'price_')===0) echo 'class="cur"'?>>
					<a href="<?php filterUrl('odby');?>/odby/<?php echo $odby=='price_desc' ? 'price_asc' : 'price_desc'?>">
						价格
					...
					<!--<dd><a href="/index.php/Home/Search/key_search/key/%E7%BE%8E%E7%9A%84/odby/price_desc">评论数</a></dd>-->
					<dd <?php if($odby == 'addtime') echo 'class="cur"'?>><a href="<?php filterUrl('odby')?>/odby/addtime">上架时间</a></dd>
				</dl>
			</div>
			<!-- 排序 end -->
				...
				<ul>
					...
					<li>
						<dl>
							...
							<a href=""><em>已有<?php echo (int)$v['xl']?>销量</em></a></dt>
						</dl>
					</li>
					<?php endforeach;?>
				</ul>
