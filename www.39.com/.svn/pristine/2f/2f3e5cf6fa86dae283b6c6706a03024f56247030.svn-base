...
<div class="main-div">
    <form name="main_form" method="POST" action="/index.php/Admin/Attribute/edit/id/2/p/1/type_id/1.html" enctype="multipart/form-data" >
        ...
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <textarea rows="6" cols="60" name="attr_options_values"><?php echo $data['attr_options_values'];?></textarea>
                </td>
            </tr>
            <tr>
